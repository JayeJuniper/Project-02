...
class Transposition(Cipher):
    ...
    def encrypt(self):
        """Encryption function modeled after the rail fence cipher using 3
        rails."""
    ...
    def decrypt(self):
        """Decryption function. Here we reverse engineer the rails used in
        encoding. since the length of the text is unaltered, the perameters
        used to create the rails can be used again here."""
